...
\begin{center}
    ...
    Квакину Семёну Дмитриевичу, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения для загрузки и анализа пользовательских метрик»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих программных продуктов по теме работы                              & 10                 & 06.04.2026    &                     \\ \hline
    Задача 1.2. Анализ программных инструментов разработки веб-приложений                            & 7                  & 12.04.2026    &                     \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц (загрузка, управление датасетом, визуализация метрик)                   & 8                  & 22.05.2026    &                     \\ \hline
    Задача 3.2. Реализация аутентификации пользователей (роли: admin, analyst, viewer)                                             & 7                  & 26.05.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для управления датасетами и метриками         & 7                  & 30.05.2026    &                     \\ \hline
    Задача 3.4. Реализация модуля загрузки CSV/Excel и автоматического вычисления метрик                                           & 12                 & 03.06.2026    &                     \\ \hline
    Задача 3.5. Разработка выгрузки агрегированных отчётов в CSV/Excel и визуализации метрик на дашборде                                                  & 6                  & 06.06.2026    &                     \\ \hline
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.55\textwidth} @{}}
    Дата выдачи задания           &
    \hfill «\underline{03}» \quad \underline{апреля} \quad 2026~г. \\
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}
    ...
    «\underline{03}» \quad \underline{апреля} \quad 2026~г. &
    \centering \rule{3.5cm}{0.4pt} \par \footnotesize (подпись) &
    \hfill С. Д. Квакин                                            \\
\end{tabularx}
}
